...
def go(args):
    ...
    logging.info(
        "Downloading raw sample.csv artifact from W&B."
    )
    ...
    # Drop outliers.
    logging.info(
        f"Dropping price outliers less than {args.min_price} "
        f"and greater than {args.max_price}."
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type=str,
        help="Fully-qualified artifact name for the output artifact.",
        required=True
    )
